...
if(isDedicated && isNil("life_market_prices")) then
{
	...
	diag_log "Cena w markecie wygenerowana!";
	
	"life_market_prices" addPublicVariableEventHandler
	{
		diag_log format["Market zaktualizowany:! %1", _this select 1];
	};
};
...
[] execVM "core\EVGA\fuelstations\init_fuelstations.sqf";
[] execVM "statusBar.sqf";
[] execVM "core\functions\restart.sqf";
[] execVM "scripts\DeleteAnimals.sqf";
